...
2 уровень - на уровне SessionFactory, почти как 1 только если другой сессии понадобился тот же обьект то хибер достанет его из кеша
3 уровень - (не уверен) тут кешируется сам запрос и параметры, если 
